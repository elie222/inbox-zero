...
Run the setup script after configuring your environment:
...
This script is intended as a one-time/admin action. It:

- registers slash commands through `setMyCommands`
- sets a profile photo only when the bot does not already have one
