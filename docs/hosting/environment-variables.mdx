...
| `NEXT_PUBLIC_AI_MODEL_SETTINGS_DISABLED` | No | Hide user AI model settings and reject account-level model setting changes. Useful for self-hosted deployments that want to manage models centrally. | `false` |
