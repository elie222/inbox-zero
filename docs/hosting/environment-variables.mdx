...
| `NEXT_PUBLIC_SELF_HOSTED_LOGIN_FOOTER_TEXT` | No | Self-hosted login footer notice. When unset, the default Google API Limited Use notice is shown. Set to an empty string to hide the notice. | Default notice |
| **Feature Flags** ||||
