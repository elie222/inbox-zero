...
For detailed setup instructions, see the [Contributing guide](/contributing):

- [Google OAuth Setup](/contributing#google-oauth-setup)
- [Microsoft OAuth Setup](/contributing#microsoft-oauth-setup)
- [Google PubSub Setup](/contributing#google-pubsub-setup)
- [LLM Setup](/contributing#llm-setup)
