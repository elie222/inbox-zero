...
| [OrcaRouter](https://www.orcarouter.ai) | `orcarouter` |
...
```env
DEFAULT_LLMS=orcarouter:anthropic/claude-sonnet-4.6,openai:gpt-5.4-mini
ECONOMY_LLMS=orcarouter:orcarouter/auto,openai:gpt-5.4-nano
CHAT_LLMS=orcarouter:orcarouter/auto,openai:gpt-5.4-mini
```
