...
<Tip>
  Want a one-click deployment instead of manual VPS setup? [Easypanel](https://easypanel.io) is a self-hosted Docker deployment platform, and Inbox Zero has a one-click deployment template there: https://easypanel.io/templates/inbox-zero
</Tip>
