...
- Last implementation commit: `a99c461ec`
- Pull request: https://github.com/elie222/inbox-zero/pull/3793
- Current task: remaining matrix cells after desktop queued-restart proofs, simplifier/reviewer, and take PR 3793 to exact-head green.
- Next action: remaining G matrix cells (coverage/retention product UI, G4 packaging); H simplifier/reviewer; watch CI on the exact head after this ledger commit.
...
| Before-dispatch failure/response loss/restart | Partial: owner reload (E14); queued archive hidden after OPFS reload (E29) | Partial: owner reload (E21) | Partial: queued archive native reopen (E31); uncertain execute (E55); hosted UI restart (E60) | Partial: queued archive native reopen (E31); uncertain execute (E55); hosted UI restart (E60) | Uncertain send reopen; uncommitted SQLite WAL crash recovery (E3) |
...
- Limitations: Coverage/retention product UI and G4 packaging remain Not run. This is a renderer UI restart, not a process kill (E31/E55 cover native reopen). Do not check E1/F4/G5.
