...
- Last implementation commit: `7e5695b3b`
- Pull request: https://github.com/elie222/inbox-zero/pull/3793
- Current task: remaining matrix cells after E101 claim fences and E102 blob GC. GitHub Playwright is the remaining mail-spec proof. CLA human signature.
...
- Limitations: Collection is not yet called from `MailEngine.runUntil` or the upload route. Do not check G4/G5.
