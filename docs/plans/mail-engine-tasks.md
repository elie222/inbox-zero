...
- Last implementation commit: `1c767c9de`
- Pull request: https://github.com/elie222/inbox-zero/pull/3793
- Current task: remaining matrix cells after Outlook web bulk/label/trash proofs, simplifier/reviewer, and take PR 3793 to exact-head green.
