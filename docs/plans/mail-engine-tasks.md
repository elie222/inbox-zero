...
- Last implementation commit: `360094243`
- Pull request: https://github.com/elie222/inbox-zero/pull/3793
- Current task: remaining matrix cells after E116 storage-pressure body eviction. GitHub Playwright is the remaining mail-spec proof. CLA human signature.
...
- Last validation:
  ...
  - GitHub Playwright `35463692396` on `56b2c36d6`: in progress when Build Check failed
...
- Limitations: Desktop hosts keep `storagePressure` false. Live OPFS quota UI remains Not run. Do not check G2/G4/G5.
