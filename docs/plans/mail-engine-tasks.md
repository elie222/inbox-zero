...
- Current task: remaining matrix cells after E78 offline queued send, and take PR 3793 to exact-head green.
- Next action: triage remaining Playwright CI failures (compose, reader); G4 packaging (macOS/Windows); CLA human signature.
