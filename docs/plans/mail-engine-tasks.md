...
- Last implementation commit: `87f8fda8b`
- Pull request: https://github.com/elie222/inbox-zero/pull/3793
- Current task: remaining matrix cells after E99 lease reclaim, E98 receipt/lease fence, and E100 command-id payload reject. CLA human signature.
...
- Limitations: Unreferenced blob collection after confirmed send is still open. Do not check G4/G5.
