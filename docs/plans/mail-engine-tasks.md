...
- Last implementation commit: `0e047d59b`
- Pull request: https://github.com/elie222/inbox-zero/pull/3793
- Current task: remaining matrix cells after desktop bulk/label/trash proofs, simplifier/reviewer, and take PR 3793 to exact-head green.
- Next action: remaining G matrix cells (hosted Electron before-dispatch UI restart, coverage/retention product UI, packaging); H simplifier/reviewer; watch CI on the exact head after this ledger commit.
...
| Before-dispatch failure/response loss/restart | Partial: owner reload (E14); queued archive hidden after OPFS reload (E29) | Partial: owner reload (E21) | Partial: queued archive native reopen (E31); uncertain execute (E55) | Partial: queued archive native reopen (E31); uncertain execute (E55) | Uncertain send reopen; uncommitted SQLite WAL crash recovery (E3) |
...
- Limitations: Hosted Electron before-dispatch UI restart, coverage/retention product UI, and G4 packaging remain Not run. Do not check E1/F4.
...
- Limitations: Hosted Electron before-dispatch UI restart, coverage/retention product UI, and G4 packaging remain Not run. Desktop bulk/container is E59. Do not check G5 boxes.
...
- Limitations: Desktop bulk/container is E59. Overlay POST `/mail` retry toasts are not the engine path. Hosted Electron before-dispatch UI restart and coverage/retention product UI remain Not run. Do not check E1.
...
- Limitations: Outlook web bulk/container is E57. Desktop bulk/container is E59. Overlay POST `/mail` retry toasts are not the engine path. Hosted Electron before-dispatch UI restart and coverage/retention product UI remain Not run. Do not check E1.
