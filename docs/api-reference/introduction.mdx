...
If you are self-hosting Inbox Zero, set the `EXTERNAL_API_ENABLED=true` environment variable to enable the API, and use your deployment URL as the base URL for requests (for example, `https://your-domain.com/api/v1`).
