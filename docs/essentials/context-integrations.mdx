...
- **More apps via Pipedream**: HubSpot, Salesforce, Pipedrive, Airtable, Slack, Jira, Zendesk, Shopify, and other popular apps are listed on the Integrations page. They connect through a free Pipedream account, where you choose which apps to share. Use the **Pipedream** row for any other app in Pipedream's catalog. Only read-oriented tools are kept.
