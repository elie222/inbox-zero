...
- **HubSpot, Salesforce, Pipedrive, Airtable, Slack, Jira, Zendesk, Shopify, and other popular apps**: connect through Pipedream. Selecting **Connect** opens Pipedream, where you sign in with a free account and choose which apps to share. Use the **Pipedream** row for any other app in Pipedream's catalog. Only read-oriented tools are kept.
