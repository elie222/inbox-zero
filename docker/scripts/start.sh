...
if [ -n "$NEXT_PUBLIC_SSO_LOGIN_BUTTON_ENABLED" ]; then
    /app/docker/scripts/replace-placeholder.sh "NEXT_PUBLIC_SSO_LOGIN_BUTTON_ENABLED_PLACEHOLDER" "$NEXT_PUBLIC_SSO_LOGIN_BUTTON_ENABLED"
fi
