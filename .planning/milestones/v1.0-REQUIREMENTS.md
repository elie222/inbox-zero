# v1.0 Requirements Archive — Personal Email AI

**Milestone:** v1.0
**Shipped:** 2026-05-17
**Outcome summary:** 43 v1 requirements across 7 categories.
- Built & validated: OPS-01..04, RECON-01..06, CLASS-01..04, CLASS-06..08, DIGEST-01..06
- Satisfied by upstream/external: RULES-01..06, FEEDBACK-03..05, BACKLOG-01
- Reinterpreted: RULES-06 (kept login)
- Dropped (no longer needed): FEEDBACK-01, FEEDBACK-02, BACKLOG-02, BACKLOG-03
- Deferred to backlog: CLASS-05 (Phase 999.2), CLASS-09 (Phase 3 revision), FEEDBACK-06
- N/A: BACKLOG-04, BACKLOG-05 (no bulk processing implemented)

Source of truth for final per-requirement status is the Traceability table at the bottom of this file. The pre-shipping checkbox states in the per-category sections were not back-edited and may show `[ ]` even where the item shipped — defer to Traceability.

This file is a frozen snapshot. The live `.planning/REQUIREMENTS.md` was deleted at v1.0 archival; the next milestone will define a fresh requirements set.
