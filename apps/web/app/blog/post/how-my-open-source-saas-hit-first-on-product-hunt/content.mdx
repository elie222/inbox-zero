...
[Inbox Zero](https://getinboxzero.com) helps you clean up your inbox fast. It lets you bulk unsubscribe from newsletters, automate emails with an [AI assistant](https://softgist.com/), automatically block cold emails, and provides email analytics.
