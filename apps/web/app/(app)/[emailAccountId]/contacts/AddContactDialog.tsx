...
import { MeetingAttendeeSuggestions } from "./MeetingAttendeeSuggestions";
...
export function AddContactDialog({
  ...
  const [tab, setTab] = useState<"details" | "meetings">("details");
      ...
      <DialogContent>
        ...
        {savedEmail ? (
          ...
          <div>
            ...
            {tab === "meetings" ? (
              <div className="mt-4">
                <MeetingAttendeeSuggestions
                  onPick={(attendee) => {
                    // Prefill and hand over to the form so company, title and
                    // the personal flag get a look before saving
                    setValue("email", attendee.email);
                    setValue("name", attendee.name ?? "");
                    setTab("details");
                  }}
                />
              </div>
...
// The shared Tabs component drives selection through the URL, which a modal
// shouldn't do — this keeps the choice local to the dialog
function SourceTab({
  active,
  onClick,
  children,
