...
import { OnboardingContent } from "@/app/(app)/[emailAccountId]/new-onboarding/OnboardingContent";
...
export const metadata: Metadata = {
  title: "New Onboarding | Inbox Zero",
  description: "Learn how Inbox Zero works and get set up.",
  alternates: { canonical: "/new-onboarding" },
};
