...
export default function OAuthDebugPage() {
  ...
  const [tokenResult, setTokenResult] = useState<Record<
    string,
    unknown
  > | null>(null);
                ...
                <div className="mt-4">
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <p className="text-sm break-all">
                      {String(debugInfo.testAuthUrl)}
                    </p>
                    <Button
                      className="mt-2"
                      onClick={() =>
                        window.open(String(debugInfo.testAuthUrl), "_blank")
                      }
                    >
                      Open Auth URL
                    </Button>
                ...
                <div className="mt-4">
                  ...
                  {tokenResult.success ? (
                    <Alert className="mt-4">
                      <AlertDescription>
                        ✅ Token exchange successful! OAuth configuration is
                        working.
                      </AlertDescription>
                    </Alert>
                  ) : (
        ...
        <Card>
          ...
          <CardContent>
            <ol className="list-decimal list-inside space-y-2 text-sm">
              <li>
                Click "Fetch Debug Info" to see your current OAuth configuration
              </li>
              <li>Click "Open Auth URL" to test the OAuth flow in a new tab</li>
              <li>
                Complete the OAuth flow and copy the authorization code from the
                redirect URL
              </li>
              <li>Paste the code in the "Authorization Code" field</li>
              <li>
                Click "Test Token Exchange" to verify the complete OAuth flow
              </li>
            </ol>
          </CardContent>
        </Card>
