...
const APPLE_PRODUCT_ID_CONFIG: Partial<Record<PremiumTier, string>> = {
  ...
  PLUS_MONTHLY: env.NEXT_PUBLIC_APPLE_IAP_PLUS_MONTHLY_PRODUCT_ID,
  PLUS_ANNUALLY: env.NEXT_PUBLIC_APPLE_IAP_PLUS_ANNUALLY_PRODUCT_ID,
  PROFESSIONAL_MONTHLY:
    env.NEXT_PUBLIC_APPLE_IAP_PROFESSIONAL_MONTHLY_PRODUCT_ID,
  PROFESSIONAL_ANNUALLY:
    env.NEXT_PUBLIC_APPLE_IAP_PROFESSIONAL_ANNUALLY_PRODUCT_ID,
};
