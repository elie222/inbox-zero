...
Label emails from partners as "Partner".
...
Label emails containing purchase orders as "PO" and forward to finance@company.com
If someone asks about product features, draft a reply with relevant feature documentation links.
Label competitor-related emails as "Competitive Intel" and forward to product@company.com
Label emails about customer references as "Reference Request".
...
Label emails about sales training or enablement as "Training".
