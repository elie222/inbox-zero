...
import { ColdEmailList } from "@/app/(app)/[account]/cold-email-blocker/ColdEmailList";
import { ColdEmailSettings } from "@/app/(app)/[account]/cold-email-blocker/ColdEmailSettings";
import { Card } from "@/components/ui/card";
import { Tabs, TabsList, TabsTrigger, TabsContent } from "@/components/ui/tabs";
import { PremiumAlertWithData } from "@/components/PremiumAlert";
import { ColdEmailRejected } from "@/app/(app)/[account]/cold-email-blocker/ColdEmailRejected";
import { PermissionsCheck } from "@/app/(app)/[account]/PermissionsCheck";
import { ColdEmailTest } from "@/app/(app)/[account]/cold-email-blocker/ColdEmailTest";
