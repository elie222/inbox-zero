...
const errorMessages: Record<string, { title: string; description: string }> = {
  ...
  requiresreconsent: {
    ...
    description:
      "Please sign in again and approve every requested permission. If your Microsoft 365 organization requires admin approval, ask your admin to approve Inbox Zero first.",
  },
};
