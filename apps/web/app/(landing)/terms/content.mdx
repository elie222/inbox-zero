Subject to these Terms of Service (this "Agreement"), [our website](/) ("Inbox Zero", "we", "us" and/or "our") provides access to Inbox Zero's cloud platform as a service (collectively, the "Services"). By using or accessing the Services, you acknowledge that you have read, understand, and agree to be bound by this Agreement.
...
Inbox Zero provides an email management tool ("the Product"). The Product is accessible at your configured domain(s) and other domains and subdomains controlled by us (collectively, "the Website").
