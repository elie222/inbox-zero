Subject to these Terms of Service (this "Agreement"), [GetInboxZero.com](/) ("Syncade", "we", "us" and/or "our") provides access to Syncade's cloud platform as a service (collectively, the "Services"). By using or accessing the Services, you acknowledge that you have read, understand, and agree to be bound by this Agreement.
