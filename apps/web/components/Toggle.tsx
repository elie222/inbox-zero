    ...
    <div>
      <Field as="div" className="flex items-center">
        ...
        <Switch
          ...
          onChange={onChange}
          className={clsx(
            enabled ? bgClass : "dark:bg-input bg-gray-200",
            "relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:ring-2 focus:ring-black focus:ring-offset-2 focus:outline-hidden dark:focus:ring-white dark:focus:ring-offset-gray-900",
          )}
        >
          ...
          <span
            ...
            className={clsx(
              ...
              "bg-background pointer-events-none inline-block h-5 w-5 transform rounded-full shadow-sm ring-0 transition duration-200 ease-in-out",
            )}
          />
        </Switch>
        {labelRight && (
