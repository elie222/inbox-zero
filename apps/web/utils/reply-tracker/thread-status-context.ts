...
const THREAD_STATUS_FIRST_MESSAGE_MAX_LENGTH = 400;
const THREAD_STATUS_MIDDLE_MESSAGE_MAX_LENGTH = 120;
const THREAD_STATUS_RECENT_TAIL_MESSAGE_MAX_LENGTH = 400;
const THREAD_STATUS_LATEST_MESSAGE_MAX_LENGTH = 1200;
