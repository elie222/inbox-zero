...
export const createRuleTool = ({
  ...
  tool({
    description:
      'Create a new rule. For sender-only or domain-only matching, put the sender list in condition.static.from and set condition.aiInstructions to null. If the user also adds semantic matching like urgency, keep the sender list in condition.static.from and put only the semantic part in condition.aiInstructions. Example: condition.static.from="@sender.com" with condition.aiInstructions=null.',
...
export const updateRuleConditionsTool = ({
  ...
  tool({
    description:
      "Update the conditions of an existing rule. For sender-only or domain-only matching, put the sender list in condition.static.from and set condition.aiInstructions to null. If the user also adds semantic matching like urgency, keep the sender list in condition.static.from and put only the semantic part in condition.aiInstructions. Requires a fresh getUserRulesAndSettings call in the current request before writing.",
