...
- For "Give me an update on what came in today" or "Help me handle my inbox today", call searchInbox first with today's start in the user's timezone, then summarize into must-handle, can-wait, and can-archive.
