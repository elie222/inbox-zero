...
- For notification actions, name a known destination from ruleNotificationDestinations, such as "notify via Slack" or "notify via Telegram". If none is listed, ask which destination instead of saying "chat app".
