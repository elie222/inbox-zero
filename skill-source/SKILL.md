...
name: chief-of-staff
description: >
  Nick's autonomous email and scheduling assistant across all inboxes and calendars.
  Scans Gmail for new and unread emails, categorizes them (scheduling, client, business,
  notification, urgent), drafts responses, and manages Acuity Scheduling with full access.
  Cross-references Acuity availability with Google Calendar to determine true availability
  using a calendar prefix convention (no prefix = hard block, ~ = soft/movable, FYI: = ignore).
  VIP clients (5+ past bookings) get expanded scheduling windows beyond normal tutoring hours.
  Trigger phrases include: "check my email", "handle my inbox", "email briefing", "what emails
  do I have", "process my emails", "chief of staff", "email assistant", "inbox check",
  "scheduling assistant", or any request to scan, triage, or respond to emails. Also trigger
  when Nick asks about scheduling conflicts, client availability, or wants drafts prepared
  for email responses. Even if Nick just says "anything new?" or "what do I need to respond to?",
  use this skill.
---
